...
function loadContent(){
    ...
    resumencontent.innerHTML = "Monkey D. Luffy , más conocido como Luffy «Sombrero de Paja» , es el protagonista principal de la serie de manga y anime One Piece. Luffy es el hermano adoptivo del conocido pirata <a href='subject-details.html#ace'>Ace</a> «Puño de Fuego» ―antiguo comandante de la segunda división "+
    "de los Piratas de Barbablanca―, así como del oficial general del Ejército Revolucionario, <a href='subject-details.html#sabo'>Sabo</a>. Su objetivo en la vida es convertirse en el próximo Rey de los Piratas, encontrar el legendario tesoro conocido como el «One Piece», que "+
    "perteneció al anterior Rey de los Piratas <a href='subject-details.html#gold'>Gol D. Roger</a>, y conquistar el Nuevo Mundo liderando una tripulación formada por grandes piratas. Como fundador y capitán de los Piratas de Sombrero de Paja, es el primer miembro que compone "+
    ...
    if (screen.width < 426){ //MOBILE
        if (document.getElementById("presentacion-luffy-l")){
            body.removeChild(document.getElementById("presentacion-luffy-l"));
        }
        ...
        if (!document.getElementsByClassName("bar")[0]){
            if (document.getElementById("presentacion-luffy-m")){
                body.removeChild(document.getElementById("presentacion-luffy-m"));
            }
